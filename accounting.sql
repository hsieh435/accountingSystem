...
-- Started on 2025-08-11 17:31:33
...
--
-- TOC entry 7 (class 2615 OID 27033)
...
--
-- TOC entry 2 (class 3079 OID 27034)
...
--
-- TOC entry 219 (class 1259 OID 27071)
...
--
-- TOC entry 220 (class 1259 OID 27076)
...
--
-- TOC entry 221 (class 1259 OID 27084)
...
CREATE TABLE public.cashcard_trade (
    ...
    trade_note text,
    CONSTRAINT cashcard_trade_transaction_type CHECK (((transaction_type)::text = ANY ((ARRAY['income'::character varying, 'expense'::character varying])::text[])))
);
...
--
-- TOC entry 222 (class 1259 OID 27090)
...
--
-- TOC entry 223 (class 1259 OID 27100)
...
CREATE TABLE public.cashflow_trade (
    ...
    trade_description text,
    trade_note text,
    CONSTRAINT cashflow_trade_transaction_type CHECK (((transaction_type)::text = ANY ((ARRAY['income'::character varying, 'expense'::character varying])::text[])))
);
...
--
-- TOC entry 224 (class 1259 OID 27106)
...
--
-- TOC entry 225 (class 1259 OID 27113)
...
--
-- TOC entry 226 (class 1259 OID 27118)
...
--
-- TOC entry 227 (class 1259 OID 27124)
...
--
-- TOC entry 228 (class 1259 OID 27133)
...
CREATE TABLE public.currency_account_trade (
    ...
    trade_description text,
    trade_note text,
    CONSTRAINT currency_account_trade_transaction_type CHECK (((transaction_type)::text = ANY ((ARRAY['income'::character varying, 'expense'::character varying])::text[])))
);
...
--
-- TOC entry 229 (class 1259 OID 27139)
...
--
-- TOC entry 230 (class 1259 OID 27145)
...
--
-- TOC entry 231 (class 1259 OID 27150)
...
--
-- TOC entry 233 (class 1259 OID 27161)
...
CREATE TABLE public.stock_account_trade (
    ...
    trade_description text,
    trade_note text,
    CONSTRAINT stock_account_trade_transaction_type CHECK (((transaction_type)::text = ANY ((ARRAY['income'::character varying, 'expense'::character varying])::text[])))
);
...
--
-- TOC entry 234 (class 1259 OID 27166)
...
--
-- TOC entry 235 (class 1259 OID 27171)
...
--
-- TOC entry 236 (class 1259 OID 27176)
...
--
-- TOC entry 237 (class 1259 OID 27181)
...
--
-- TOC entry 238 (class 1259 OID 27191)
...
--
-- TOC entry 4968 (class 0 OID 27071)
-- Dependencies: 219
...
--
-- TOC entry 4969 (class 0 OID 27076)
-- Dependencies: 220
...
--
-- TOC entry 4970 (class 0 OID 27084)
-- Dependencies: 221
...
--
-- TOC entry 4971 (class 0 OID 27090)
-- Dependencies: 222
...
--
-- TOC entry 4972 (class 0 OID 27100)
-- Dependencies: 223
...
--
-- TOC entry 4973 (class 0 OID 27106)
-- Dependencies: 224
-- Data for Name: creditcard_list; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.creditcard_list (creditcard_id, user_id, creditcard_name, creditcard_bank_code, creditcard_bank_name, creditcard_scheme, currency, credit_per_month, expiration_date, alert_value, open_alert, enable, created_date, note) FROM stdin;
\.


--
-- TOC entry 4974 (class 0 OID 27113)
-- Dependencies: 225
...
--
-- TOC entry 4975 (class 0 OID 27118)
-- Dependencies: 226
...
--
-- TOC entry 4976 (class 0 OID 27124)
-- Dependencies: 227
-- Data for Name: currency_account_list; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.currency_account_list (account_id, user_id, account_name, account_type, account_bank_code, account_bank_name, currency, starting_amount, present_amount, minimum_value_allowed, alert_value, open_alert, is_salary_account, enable, created_date, note) FROM stdin;
\.


--
-- TOC entry 4977 (class 0 OID 27133)
-- Dependencies: 228
...
--
-- TOC entry 4978 (class 0 OID 27139)
-- Dependencies: 229
...
--
-- TOC entry 4979 (class 0 OID 27145)
-- Dependencies: 230
...
parameterSetting	currencySetting	貨幣設定	/currencySetting	2
informationSearching	stockInfo	股市查詢	/stockInfo	2
informationSearching	currencyExchangeRateInfo	外幣匯率查詢	/currencyExchangeRateInfo	1
\.


--
-- TOC entry 4980 (class 0 OID 27150)
-- Dependencies: 231
...
parameterSetting	參數設定	5
informationSearching	資訊查詢	4
\.


--
-- TOC entry 4981 (class 0 OID 27155)
-- Dependencies: 232
-- Data for Name: stock_account_list; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.stock_account_list (account_id, user_id, account_name, account_type, account_bank_code, account_bank_name, currency, starting_amount, present_amount, minimum_value_allowed, alert_value, open_alert, enable, created_date, note) FROM stdin;
\.


--
-- TOC entry 4982 (class 0 OID 27161)
-- Dependencies: 233
...
--
-- TOC entry 4983 (class 0 OID 27166)
-- Dependencies: 234
...
--
-- TOC entry 4984 (class 0 OID 27171)
-- Dependencies: 235
...
--
-- TOC entry 4985 (class 0 OID 27176)
-- Dependencies: 236
...
--
-- TOC entry 4986 (class 0 OID 27181)
-- Dependencies: 237
...
--
-- TOC entry 4987 (class 0 OID 27191)
-- Dependencies: 238
...
--
-- TOC entry 4784 (class 2606 OID 27197)
...
--
-- TOC entry 4786 (class 2606 OID 27238)
...
--
-- TOC entry 4788 (class 2606 OID 27201)
...
--
-- TOC entry 4790 (class 2606 OID 27203)
...
--
-- TOC entry 4792 (class 2606 OID 27205)
...
--
-- TOC entry 4798 (class 2606 OID 27209)
...
--
-- TOC entry 4794 (class 2606 OID 27240)
...
--
-- TOC entry 4796 (class 2606 OID 27211)
...
--
-- TOC entry 4800 (class 2606 OID 27213)
...
--
-- TOC entry 4802 (class 2606 OID 27215)
...
--
-- TOC entry 4804 (class 2606 OID 27217)
...
--
-- TOC entry 4808 (class 2606 OID 27219)
...
--
-- TOC entry 4806 (class 2606 OID 27221)
...
--
-- TOC entry 4810 (class 2606 OID 27223)
...
--
-- TOC entry 4812 (class 2606 OID 27225)
...
--
-- TOC entry 4814 (class 2606 OID 27227)
...
--
-- TOC entry 4816 (class 2606 OID 27229)
...
--
-- TOC entry 4818 (class 2606 OID 27231)
...
--
-- TOC entry 4820 (class 2606 OID 27233)
...
--
-- TOC entry 4822 (class 2606 OID 27235)
...
-- Completed on 2025-08-11 17:31:33
