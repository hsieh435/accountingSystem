  ...
  <div class="flex-col justify-center items-center w-full">
    <div class="bg-sky-200">
      <UNavigationMenu
        ...
        :ui="{ viewportWrapper: 'border-0 border-black p-0', viewport: 'border-0 border-purple-500', content: 'w-fit border-0 border-rose-500', indicator: 'border-0 border-sky-500' }" />
    </div>
