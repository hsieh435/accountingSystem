<template>
  ...
  <UModal
    ...
    <!-- <UButton class="btn-aomidori" label="更改密碼" icon="save" @click="open = true" /> -->
    <UButton class="btn-aomidori px-1" @click="open = true">
      <font-awesome-icon :icon="['far', 'save']" /><span class="mx-1">更改密碼</span>
    </UButton>
    <!-- <ui-buttonGroup showSave :saveText="'更改密碼'" @dataSave="open = true" /> -->
    <template #body>
      <div class="flex flex-col justify-center items-center gap-2">
        ...
        <div>
          <div class="d-flex flex-row justify-start items-center grid grid-cols-6">
            ...
            <input :class="tailwindStyles.getInputClasses('col-span-3')" id="userAccount" v-model="userAccount" />
          </div>
        ...
        <div>
          ...
          <div class="d-flex flex-row justify-start items-center grid grid-cols-6 my-2">
            ...
            <input
              :class="tailwindStyles.getInputClasses('col-span-3')"
              id="userNewPasswordSecond"
              v-model="userNewPasswordSecond"
              type="password" />
          </div>
