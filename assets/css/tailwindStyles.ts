...
export const tailwindStyles = {
  ...
  thClasses: `table-cell border-x border-gray-200 bg-black text-white px-1 py-1 first:border-0 first:rounded-tl-xl last:border-l last:rounded-tr-xl last:${tableLastColumn}`,
  ...
  tdLastClasses: `${tableLastColumn} border border-gray-200 flex flex-row justify-center items-center px-1 py-1 group-hover:bg-gray-200 group-hover:border-gray-300`,
  noDataClasses: "text-black mx-3",


  selectClasses: "block border border-gray-300 rounded-md shadow-sm text-gray-700 bg-white px-2 py-1 my-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
